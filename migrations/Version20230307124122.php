 ...
 */
final class Version20230307124122 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE movie (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, release_date DATE NOT NULL, duration SMALLINT NOT NULL, summary VARCHAR(255) NOT NULL, synopsis VARCHAR(4000) NOT NULL, poster VARCHAR(2048) DEFAULT NULL, rating NUMERIC(2, 1) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
